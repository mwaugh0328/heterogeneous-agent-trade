...
\begin{frame}[t]{Macro-Elasticities: The H-A Trade Elasticity}
\medskip
Define the aggregate trade elasticity as:
\begin{align*}
\theta_{ij} := \frac{\partial ( M_{ij} / M_{ii} )}{\partial d_{ij}} \times \frac{d_{ij}}{( M_{ij} / M_{ii} )}
\end{align*}\\
\bigskip
\uncover<2>{\textbf{Proposition \#1: The H-A Trade Elasticity.} The trade elasticity between country $i$ and country $j$ is:
\begin{align}
...
\bigskip
\medskip
Mimics the results of \citet{anderson1987ces} and \citet{arkolakis2012new}. But stronger as this is a far more complex economy\ldots
\end{frame}
