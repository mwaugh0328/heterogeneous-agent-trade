...
\end{itemize}
\medskip
One mechanism behind \textbf{2.} are inefficiencies arising from market incompleteness\ldots Might trade policy be useful? \citet{Corden_74}, \citet{Eaton85}.\\
\bigskip
\medskip
This paper:\\
\smallskip
...
\smallskip
  \item Explore bilateral reduction in trade costs. No transition path today, ran out of time!
\end{itemize}
\bigskip
...
\begin{frame}[t]{U.S. Welfare: 10\% Reduction to a Small Market (Australia), {\color{red} Fixed Prices} }
\vspace{-.5cm}
\begin{figure}[!t]
...
\hline
\hline
& \footnotesize  Fixed Prices & GE: Prices Adjust \\
...
\begin{frame}[t]{U.S. Welfare: 10\% Reduction to a Medium Market (Japan), {\color{red} Fixed Prices} }
\vspace{-.5cm}
\begin{figure}[!t]
...
\begin{frame}[t]{U.S. Welfare: 10\% Reduction in Trade Costs to a Medium Market (Japan), {\color{red} GE} }
\vspace{-.5cm}
\begin{figure}[!t]
...
\footnotesize  Upper quartile  & 0.0535 & 0.0299  \\
\footnotesize  Aggregate & 0.0031 & -0.0403 \\
\cmidrule(lr){2-2}  \cmidrule(lr){3-3}
...
\begin{frame}[t]{U.S. Welfare: 10\% Reduction to a Large Market (Canada), {\color{red} Fixed Prices} }
\vspace{-.5cm}
\begin{figure}[t]
...
\cmidrule(lr){2-2}  \cmidrule(lr){3-3}
\footnotesize  Asset Quartile & \footnotesize  Welfare (\% Change) & \footnotesize  Welfare (\% Change) \\
\footnotesize  Bottom quartile  & 0.21 & 0.058 \\
\footnotesize  Median & 0.28 & 0.090 \\
\footnotesize  Upper quartile  & 0.39 & 0.084  \\
\footnotesize  Aggregate & 0.30 & 0.14  \\
\cmidrule(lr){2-2}  \cmidrule(lr){3-3}
...
\smallskip
These are some issues I'm facing:\\
\bigskip
...
\vspace{-.5cm}
\begin{figure}[!t]
\centering{\includegraphics[scale = .5]{../notes/figures/welfare-elasticity.pdf}}
\end{figure}
\end{frame}
