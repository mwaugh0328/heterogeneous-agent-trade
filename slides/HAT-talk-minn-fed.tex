...
%\begin{frame}[t]{Before Junior Scholar\ldots }
%\begin{figure}
%\includegraphics[scale = .08]{pre-junior-scholar.png} \phantom{\includegraphics[scale = .5]{after-junior-scholar.png}} \phantom{\includegraphics[scale = .5]{after-bank.png}}
%\end{figure}
%
%\end{frame}
%
%\begin{frame}[t]{After Junior Scholar (and 2 kids, tenure, etc)\ldots}
%\begin{figure}
%\includegraphics[scale = .08]{pre-junior-scholar.png} \includegraphics[scale = .5]{after-junior-scholar.png} \phantom{\includegraphics[scale = .5]{after-bank.png}}
%\end{figure}
%
%\end{frame}
%
%\begin{frame}[t]{Rejoining the Bank}
%\begin{figure}
%\includegraphics[scale = .08]{pre-junior-scholar.png} \includegraphics[scale = .5]{after-junior-scholar.png} \includegraphics[scale = .5]{after-bank.png}
%\end{figure}
%
%\end{frame}
...
\begin{frame}[t]{Heterogenous Price Elasticities and Trade | How I do it}
...
\smallskip
\item The welfare gains from trade.
\smallskip
...
Quantitatively:
\begin{itemize}
\item I work at a scale typically reserved for static models | I calibrate a 19 country model (the \citet{eaton2002technology} data set) to match trade flow data using ``gravity as a guide.''
\smallskip
\item I find large gains from trade\ldots \\
\medskip
The poorest households gain 4.5X more than the richest; the average gains from trade are 3X than representative agent benchmarks.
\end{itemize}
\end{frame}
