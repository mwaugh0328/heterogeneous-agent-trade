...
v(g(a,z,d), z')
\end{align}
so the first term inside indicates that $v$ depends upon the choice of $a$ and the dependence of $v$ on $d$ (and not through assets) is implicit. Then the total derivative of this is
\begin{align}
