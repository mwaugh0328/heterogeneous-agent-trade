...
This paper studies the implications of household heterogeneity for trade. My model features household-level price ( trade ) elasticities that increase with income and wealth and I connect these elasticities with the marginal utility of consumption. The gains from trade reflect a household's exposure to trade and its price elasticity. Thus, conditional on exposure, trade-induced reductions in price are more valuable for poor, high marginal utility households.  Quantitatively, I calibrate the model to match bilateral trade flows for 19 countries and micro facts about household-level expenditure patterns and price elasticities. The gains from trade are pro-poor with the poorest households gaining six times more than the richest. The average gains from trade are nearly three times larger than representative agent benchmarks.
...
This paper studies the implications of household heterogeneity for trade. From the perspective of trade, household heterogeneity is interesting because of the notion that some benefit from trade and others don't. One aspect of these unequal gains relates to the idea that rich and poor consumers have different sensitivities to price and, thus, they shape the gains from trade.  I develop this idea in a model that results in heterogenous price sensitivity and I study it's implications qualitatively and quantitatively.

The main implication is the following: heterogeneity in price sensitivity reflects heterogeneity in the marginal utility of consumption across households. Then even if rich and poor households are equally exposed to changes in prices | heterogeneity in price sensitivity implies that they value a price change differently. Thus, poor, high marginal utility households, who turnout to be very sensitive to price tend to benefit more from trade than rich households. Quantitatively, I find that this mechanism is powerful with the poorest households gaining six times more than the richest. And the average gains from trade are nearly times larger than standard, representative agent benchmarks.
...
In the previous section, I focused on what amount to level changes in utils. Here I define an equivalent variation measure that has more interpretable units.
...
\end{align}
where I'm evaluating this with the prices prevailing at the new steady state and, hence, there are no $t$ subscripts. I focus this section on across steady states, not transition paths. Those may be important, but add an additional computational challenge which I've decided to abstract from.
...
\end{align}
To be clear, this says  a household with states $a,z$ must have their income increased today and for the infinite future increased by the number $\tau_{i,a,z}$. The underscore notation indexes this value by the original-type of household I'm looking at, and so there is one number for a household with $a,z$ states in country $i$. The $\tau$s that solve (\ref{eq:welfare-eqv}) is my primary measure of welfare at the household level.\footnote{To be clear, there are alternatives like a Lucas-style consumption equivalent variation | this however confronts questions about which consumption. I also explored a lump sum transfer version of \ref{eq:welfare-eqv} as well. The proportional increase measure is my preference because it's essentially the same that is done in \citet{auer2022unequal}.}



\subsection{10\% Reduction in US Trade Costs}

In this section, I study a ten percent reduction in all US trade costs. That is $d_{us,j}$ is shifted down for all $j$ partners by $0.90$. The top panel of Table \ref{tb-welfare} reports how much US imports change in this counterfactual and how the global interest rate changes.

Figure \ref{fig:welfare-households} reports how the welfare gains very across households. Here households are binned by quantiles of the initial distribution of consumption expenditure and the y-axis reports average welfare gains within each bin. For example, households in the bottom 20th percentile of the consumption expenditure distribution experience gains of about $2.6$.
...
\begin{figure}[!t]
\centering{\includegraphics[scale = .55]{./figures/ge-welfare-household-fixR.pdf}}
...
There is only a modest effect of interest rates.\footnote{Also, because interest rates don't change that much, all households in the US gain in this counterfactual.} There are  Since intrust rates decline in the counterfactual, rich households gain slightly more ($0.44$ vs. $0.42$) when $R$ is held fixed. These households are those holding assets, are most effected by the decline in interest rates, but also loose less since they are rich and their marginal utility is low. For the poorest households the situation is flipped. They gain less ($2.15$ vs. $2.59$) when $R$ is held fixed. These are debtor households (or soon to be) and thus any decline in interest rates relaxes their budget constraint. And because these are high marginal utility households, the small change in interest rates is magnified for them.
