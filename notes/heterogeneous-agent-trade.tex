...
$\Delta$ US Imports / GDP  & $1.7$ & $1.1$  \\
$\Delta R_{us} / w_{us}$  & $4.6$ & $4.5$  \\
\hline
Average Welfare Gain & $1.35$ & $0.21$\\
Ratio of Bottom 20 vs. Top 20 Welfare & $4.5$ & $0.78$\\
ACR Implied Gains  & $0.43$ & $0.29$ \\
\hline
\end{tabular}
\\[0.5ex]
\parbox{5.75in}{\footnotesize \textbf{Note:} Imports / GDP is in percentage points; $\Delta R_{us} / w_{us}$ and welfare are in percent change. Bottom 20 vs. Top 20 Welfare reports the ratio of household welfare for those in the bottom 20th percentile of the expenditure distribution vs. those at the top 20th.}
\end{center}
\end{table}
