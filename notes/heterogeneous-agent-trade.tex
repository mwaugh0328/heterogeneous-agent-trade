...
Before proceeding, I'll note that lack of physical capital in the model. As I discuss next, the households are saving in via pure exchange as in \citet{huggett1993risk} rather than in physical capital as in \citet{aiyagari1994uninsured}.
...
\begin{align}
a_{t+1} + p_{ij}c_{ijt}  \leq    R_{i} a_{t} + w_{i} z_{t}.\label{eq:trade-budget-constraint}
\end{align}
...
Equation (\ref{eq:log_sum-home}) it can be used to deliver more insight about the how the savings motives of households are interacting with the variety choices. Focusing on a household consuming the home good, the Euler Equation in (\ref{eq:euler_equation}) can be represented as:
\begin{align}
