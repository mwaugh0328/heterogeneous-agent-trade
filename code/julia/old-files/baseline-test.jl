...
mdl_prm = world_model_params(Ncntry = Ncntry, Na = 100, β = 0.95,
γ = 1.50, ϕ = 2.0, amax = 5.0, σϵ = 0.25, d = d, TFP = TFP, L = L)
...
p = (Wsol ./ mdl_prm.TFP) .* mdl_prm.d[1,:]

@time compute_eq(Rsol[1], Wsol[1], p, mdl_prm, hh_solution_method = "itteration");

# @time Y, tradeflows, A_demand, tradeshare, hh, dist = world_equillibrium(Rsol,
