...
# this the fixed R calculation, so keep R at 1%
# but use new wages...

Δ_Y, Δ_tradeflows, Δ_A_demand, Gbudget, Δ_tradeshare, Δ_hh, Δ_dist = world_equillibrium(Rsol, Δ_Wsol, 
...
# needed at the **old** prices to match **new** value function Δ_hh          
λτeqv =  eq_variation_porportional(R, W, p, Δ_hh[home_country], dist[home_country].state_index, foo_hh_prm)

writedlm("welfare-quality-fixR.txt", λτeqv)
...
root = rootfile*"ek-us-cross-section-quality60-fixR.csv"
